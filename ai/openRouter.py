...
def jalankan_openrouter():
    ...
    try:
        ...
        prompt = (
            ...
            "Your task is to analyze the provided data, and generate a precise trading signal.\n\n"
            # synthesize macro/micro news
            "### DATA TO ANALYZE:\n"
